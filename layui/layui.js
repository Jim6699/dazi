...
! function(l) {
	...
	(r.prototype = [])
	.constructor = r, h.extend = function() {
		var t, e = 1,
			n = arguments,
			o = function(t, e) {
		...
		try {
			return new Function("return " + (t.attr(n) || "{}"))()
		} catch (o) {
			return hint.error(e.errorText || "parseerror: " + o, "error"), {}
		}
...
! function(i, f) {
	...
	var n = i.layui && layui.define,
		l = {
			...
			link: function(e, t, a) {
				p.path && i.lay && lay.layui && lay.layui.link(p.path + e, t, a)
			}
		},
		e = i.LAYUI_GLOBAL || {},
		p = {
			...
			ready: function(e) {
				var t = "laydate",
					a = (n ? "modules/" : "css/") + "laydate.css?v=" + p.v;
		...
		T = function(e) {
			var t = this,
				a = (t.index = ++p.index, t.config = lay.extend({}, t.config, p.config, e), lay(e.elem || t.config.elem));
			if (1 < a.length) return lay.each(a, function() {
				p.render(lay.extend({}, t.config, lay.options(this), {
					elem: this
				}))
			}), t;
			(e = t.config)
			.id = "id" in e ? e.id : t.index, p.ready(function() {
				t.init()
			})
		},
	...
	s.formatArr = function(e) {
		...
		o.elem = lay(o.elem), o.eventElem = lay(o.eventElem), o.elem[0] && ((e = s.that[o.elem.attr("lay-key")]) && e.destroy && e.destroy(), "array" !== layui.type(o.theme) && (o.theme = [o.theme]), o.fullPanel && ("datetime" !== o.type || o.range) && delete o.fullPanel, r.rangeStr = o.range ? "string" == typeof o.range ? o.range : "-" : "", "array" === layui.type(o.range) && (r.rangeElem = [lay(o.range[0]), lay(o.range[1])]), a[o.type] || (i.console && console.error && console.error("laydate type error:'" + o.type + "' is not supported"), o.type = "date"), o.format === a.date && (o.format = a[o.type] || a.date), r.format = s.formatArr(o.format), o.weekStart && !/^[0-6]$/.test(o.weekStart) && (e = r.lang(), o.weekStart = e.weeks.indexOf(o.weekStart), -1 === o.weekStart && (o.weekStart = 0)), r.EXP_IF = "", r.EXP_SPLIT = "", lay.each(r.format, function(e, t) {
			...
			l = "number" == typeof o[t] ? (a = o[t], n = new Date, n = r.newDate({
				...
				], [e.getHours(), e.getMinutes(), e.getSeconds()]) : (i = (o[t].match(/\d+-\d+-\d+/) || [""])[0].split("-"), (o[t].match(/\d+:\d+:\d+/) || [""])[0].split(":")), o[t] = {
				year: 0 | i[0] || (new Date)
					.getFullYear(),
		...
		var a, e, n, i, l = this,
			...
			s = l.lang(),
			r = "static" === o.position,
			y = l.elem = lay.elem("div", {
				id: l.elemID,
				"class": ["layui-laydate", o.range ? " layui-laydate-range" : "", r ? " " + g : "", o.fullPanel ? " laydate-theme-fullpanel" : "", (a = "", lay.each(o.theme, function(e, t) {
			...
			c = l.elemCont = [],
			u = l.table = [],
			t = l.footer = lay.elem("div", {
				"class": "layui-laydate-footer"
			}),
			h = (o.zIndex && (y.style.zIndex = o.zIndex), lay.each(new Array(2), function(e) {
					...
					}), i.insertBefore(l, i.children[0]), n.appendChild(i), d[e] = lay.elem("div", {
						"class": "layui-laydate-main laydate-main-list-" + e
					}), d[e].appendChild(a), d[e].appendChild(n), m.push(t), c.push(n), u.push(i)
				}), lay(t)
				.html((e = [], n = [], "datetime" === o.type && e.push('<span lay-type="datetime" class="' + k + '">' + s.timeTips + "</span>"), (o.range || "datetime" !== o.type || o.fullPanel) && e.push('<span class="' + v + '" title="' + s.preview + '"></span>'), lay.each(o.btns, function(e, t) {
					var a = s.tools[t] || "btn";
					o.range && "now" === t || (r && "clear" === t && (a = "cn" === o.lang ? "\u91cd\u7f6e" : "Reset"), n.push('<span lay-type="' + t + '" class="laydate-btns-' + t + '">' + a + "</span>"))
				}), e.push('<div class="laydate-footer-btns">' + n.join("") + "</div>"), e.join(""))), lay.each(d, function(e, t) {
					y.appendChild(t)
				}), o.showBottom && y.appendChild(t), []);
		lay.each(o.theme, function(e, t) {
				/^#/.test(t) && (i = i || lay.elem("style"), h.push(["#{{id}} .layui-laydate-header{background-color:{{theme}};}", "#{{id}} li.layui-this,#{{id}} td.layui-this>div{background-color:{{theme}} !important;}", -1 !== o.theme.indexOf("circle") ? "" : "#{{id}} .layui-this{background-color:{{theme}} !important;}"].join("")
					.replace(/{{id}}/g, l.elemID)
					.replace(/{{theme}}/g, t)))
			}), i && (h = h.join(""), "styleSheet" in i ? (i.setAttribute("type", "text/css"), i.styleSheet.cssText = h) : i.innerHTML = h, lay(y)
				.addClass("laydate-theme-molv"), y.appendChild(i)), l.remove(T.thisElemDate), p.thisId = o.id, r ? o.elem.append(y) : (f.body.appendChild(y), l.position()), l.checkDate()
			.calendar(null, 0, "init"), l.changeEvent(), T.thisElemDate = l.elemID, l.renderAdditional(), "function" == typeof o.ready && o.ready(lay.extend({}, o.dateTime, {
		...
		var t = this,
			a = t.config,
			n = lay("#" + (e || t.elemID));
		return n[0] && (n.hasClass(g) || t.checkDate(function() {
			n.remove(), delete p.thisId, "function" == typeof a.close && a.close(t)
		})), t
		...
		var t, o, s = this,
			...
			d = function(e) {
				e.year > h[1] && (e.year = h[1], o = !0), 11 < e.month && (e.month = 11, o = !0), 59 < e.seconds && (e.seconds = 0, e.minutes++, o = !0), 59 < e.minutes && (e.minutes = 0, e.hours++, o = !0), 23 < e.hours && (e.hours = 0, o = !0), t = p.getEndDate(e.month + 1, e.year), e.date > t && (e.date = t, o = !0)
			},
			r = function(n, i, l) {
		...
		return u(), "string" == typeof l && l ? s.EXP_IF.test(l) ? y.range ? (l = l.split(" " + s.rangeStr + " "), lay.each([y.dateTime, s.endDate], function(e, t) {
			r(t, l[e], e)
		})) : r(n, l) : (s.hint(a.formatError[0] + (y.range ? y.format + " " + s.rangeStr + " " + y.format : y.format) + a.formatError[1]), o = !0) : l && "date" === layui.type(l) ? y.dateTime = s.systemDate(l) : (y.dateTime = s.systemDate(), delete s.startTime, delete s.endDate, u(), delete s.endTime), s.rangeElem && (u = [s.rangeElem[0].val(), s.rangeElem[1].val()], m = [y.dateTime, s.endDate], lay.each(u, function(e, t) {
			s.EXP_IF_ONE.test(t) && r(m[e], t, e)
		})), d(n), y.range && d(s.endDate), o && l && s.setValue(!y.range || s.endDate ? s.parse() : ""), s.getDateTime(n) > s.getDateTime(y.max) ? (n = y.dateTime = lay.extend({}, y.max), c = !0) : s.getDateTime(n) < s.getDateTime(y.min) && (n = y.dateTime = lay.extend({}, y.min), c = !0), y.range && ((s.getDateTime(s.endDate) < s.getDateTime(y.min) || s.getDateTime(s.endDate) > s.getDateTime(y.max)) && (s.endDate = lay.extend({}, y.max), c = !0), s.startTime = {
		...
		}), c && l && (s.setValue(s.parse()), s.hint("value " + a.invalidDate + a.formatError[1])), e && e(), s
	}, T.prototype.mark = function(e, a) {
		var n, t = this.config;
		return lay.each(t.mark, function(e, t) {
				e = e.split("-");
				e[0] != a[0] && 0 != e[0] || e[1] != a[1] && 0 != e[1] || e[2] != a[2] || (n = t || a[2])
			}), n && e.find("div")
			.html('<span class="laydate-day-mark">' + n + "</span>"), this
	}, T.prototype.holidays = function(n, i) {
		var e = this.config,
			l = ["", "work"];
		return "array" !== layui.type(e.holidays) || lay.each(e.holidays, function(a, e) {
			lay.each(e, function(e, t) {
				t === n.attr("lay-ymd") && n.find("div")
					.html('<span class="laydate-day-holidays"' + (l[a] ? 'type="' + l[a] + '"' : "") + ">" + i[2] + "</span>")
			})
		}), this
		...
		return lay.each({
			...
			l[e] = i.newDate(lay.extend({
				...
				.getTime()
		}), a = l.now < l.min || l.now > l.max, t.elem && t.elem[a ? "addClass" : "removeClass"](w), a
		...
		var i, l, r, o = this,
			...
			.find("span");
		return s.year < h[0] && (s.year = h[0], o.hint(d.invalidDate)), s.year > h[1] && (s.year = h[1], o.hint(d.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, s)), y.setFullYear(s.year, s.month, 1), i = (y.getDay() + (7 - n.weekStart)) % 7, l = p.getEndDate(s.month || 12, s.year), r = p.getEndDate(s.month + 1, s.year), lay.each(c, function(e, t) {
				var a = [s.year, s.month],
					n = 0;
				(t = lay(t))
				.removeAttr("class"), e < i ? (n = l - i + e, t.addClass("laydate-day-prev"), a = o.getAsYM(s.year, s.month, "sub")) : i <= e && e < r + i ? (n = e - i) + 1 === s.date && t.addClass(x) : (n = e - r - i, t.addClass("laydate-day-next"), a = o.getAsYM(s.year, s.month)), a[1]++, a[2] = n + 1, t.attr("lay-ymd", a.join("-"))
					.html("<div>" + a[2] + "</div>"), o.mark(t, a)
					.holidays(t, a)
					.limit({
						elem: t,
						date: {
			...
			.attr("lay-ym", s.year + "-" + (s.month + 1)), "cn" === n.lang ? (lay(t[0])
				...
				[s.year, s.month + 1]
			], o.list(n.type, 0))), n.range && "init" === a && !e && o.calendar(o.endDate, 1), n.range || (y = ["hours", "minutes", "seconds"], o.limit({
				elem: lay(o.footer)
	...
	}, T.prototype.list = function(n, i) {
		var l, r, e, o, s = this,
			y = s.config,
			d = y.dateTime,
			m = s.lang(),
			t = y.range && "date" !== y.type && "datetime" !== y.type,
			c = lay.elem("ul", {
				"class": M + " " + {
		...
		return v[0] < 1 && (v[0] = 1), "year" === n ? (e = l = v[0] - 7, l < 1 && (e = l = 1), lay.each(new Array(15), function(e) {
				...
				l == v[0] && lay(t)
					.addClass(x), t.innerHTML = l + g, c.appendChild(t), s.limit({
						elem: lay(t),
						date: a,
						index: i,
						type: n
			...
			.attr("lay-ym", l - 8 + "-" + v[1])
			.html(e + g + " - " + (l - 1) + g)) : "month" === n ? (lay.each(new Array(12), function(e) {
				var t = lay.elem("li", {
						"lay-ym": e
					}),
					a = {
				...
				e + 1 == v[1] && lay(t)
					.addClass(x), t.innerHTML = m.month[e] + (p ? "\u6708" : ""), c.appendChild(t), s.limit({
						elem: lay(t),
						date: a,
						index: i,
						type: n
		...
		}, y.range ? s[D] || (s[D] = "startTime" === D ? d : s.endDate) : s[D] = d, lay.each([24, 60, 60], function(t, e) {
			var a = lay.elem("li"),
				n = ["<p>" + m.time[t] + "</p><ol>"];
			lay.each(new Array(e), function(e) {
				n.push("<li" + (s[D][T[t]] === e ? ' class="' + x + '"' : "") + ">" + lay.digit(e, 2) + "</li>")
			}), a.innerHTML = n.join("") + "</ol>", c.appendChild(a)
		}), r()), f && h.removeChild(f), h.appendChild(c), "year" === n || "month" === n ? (lay(s.elemMain[i])
			.addClass("laydate-ym-show"), lay(c)
			.find("li")
			.on("click", function() {
				var e = 0 | lay(this)
					.attr("lay-ym");
				lay(this)
					.hasClass(w) || (0 === i ? (d[n] = e, s.limit({
							elem: lay(s.footer)
								.find(E),
							index: 0
						})) : s.endDate[n] = e, "year" === y.type || "month" === y.type ? (lay(c)
							.find("." + x)
							.removeClass(x), lay(this)
							.addClass(x), "month" === y.type && "year" === n && (s.listYM[i][0] = e, t && ((i ? s.endDate : d)
								.year = e), s.list("month", i))) : (s.checkDate("limit")
							.calendar(null, i), s.closeList()), s.setBtnStatus(), y.range || ("month" === y.type && "month" === n || "year" === y.type && "year" === n) && s.setValue(s.parse())
						.remove()
						.done(), s.done(null, "change"), lay(s.footer)
						.find("." + k)
						.removeClass(w))
			})) : (e = lay.elem("span", {
				"class": C
				...
				lay(c)
					...
					.each(function(e) {
						var a = this,
							t = lay(a)
							.find("li");
						a.scrollTop = 30 * (s[D][T[e]] - 2), a.scrollTop <= 0 && t.each(function(e, t) {
							if (!lay(this)
								.hasClass(w)) return a.scrollTop = 30 * (e - 2), !0
						})
					})
			}, u = lay(a[2])
			.find("." + C), o(), e.innerHTML = y.range ? [m.startTime, m.endTime][i] : m.timeTips, lay(s.elemMain[i])
			.addClass("laydate-time-show"), u[0] && u.remove(), a[2].appendChild(e), lay(c)
			.find("ol")
			.each(function(t) {
				var a = this;
				lay(a)
					...
					.on("click", function() {
						...
						lay(this)
							.hasClass(w) || (y.range ? s[D][T[t]] = e : d[T[t]] = e, lay(a)
								.find("." + x)
								.removeClass(x), lay(this)
								.addClass(x), r(), o(), !s.endDate && "time" !== y.type || s.done(null, "change"), s.setBtnStatus())
					})
			})), s
		...
		a.isPreview && (e = lay(t.elem)
			.find("." + v), a = !a.range || t.endDate ? t.parse() : "", e.html(a)
			.css({
				color: "#5FB878"
			}), setTimeout(function() {
				e.css({
	...
	}, T.prototype.renderAdditional = function() {
	...
	}, T.prototype.choose = function(e, a) {
		var n = this,
			i = n.config,
			l = n.thisDateTime(a),
			t = (lay(n.elem)
				.find("td"), {
					year: 0 | (t = e.attr("lay-ymd")
						.split("-"))[0],
					month: (0 | t[1]) - 1,
					date: 0 | t[2]
				});
		e.hasClass(w) || (lay.extend(l, t), i.range ? (lay.each(["startTime", "endTime"], function(e, t) {
					n[t] = n[t] || {
						hours: e ? 23 : 0,
						minutes: e ? 59 : 0,
						seconds: e ? 59 : 0
				...
				.done(null, "change")) : "static" === i.position ? n.calendar()
			.done()
			.done(null, "change") : "date" === i.type ? n.setValue(n.parse())
			.remove()
			.done() : "datetime" === i.type && n.calendar()
			.done(null, "change"))
		...
		var a = this,
			...
			o = {
				datetime: function() {
					lay(t)
						.hasClass(w) || (a.list("time", 0), n.range && a.list("time", 1), lay(t)
							.attr("lay-type", "date")
							.html(a.lang()
								.dateTips))
				},
				...
				now: function() {
					var e = new Date;
					if (lay(t)
						.hasClass(w)) return a.hint(i.tools.now + ", " + i.invalidDate);
				...
				confirm: function() {
					if (n.range) {
						if (lay(t)
							.hasClass(w)) return a.hint("time" === n.type ? i.timeout.replace(/\u65e5\u671f/g, "\u65f6\u95f4") : i.timeout)
					} else if (lay(t)
						.hasClass(w)) return a.hint(i.invalidDate);
					a.setValue(a.parse())
						.remove(), a.done()
				}
			};
		o[e] && o[e]()
	}, T.prototype.change = function(n) {
		var i = this,
			l = i.config,
			r = i.thisDateTime(n),
			...
			e = function(e) {
				...
				return t && (y[0] = e ? y[0] - 15 : y[0] + 15, i.list("year", n)), a && (e ? y[0]-- : y[0]++, i.list("month", n)), (t || a) && (lay.extend(r, {
					year: y[0]
				}), o && (r.year = y[0]), l.range || i.done(null, "change"), l.range || i.limit({
					elem: lay(i.footer)
						.find(E),
					date: {
						year: y[0]
		...
		a.elem[0] && !a.elem[0].eventHandler && (a.elem.on(a.trigger, e = function() {
			p.thisId !== a.id && (t.bindElem = this, t.render())
		}), a.elem[0].eventHandler = !0, a.eventElem.on(a.trigger, e), t.destroy = function() {
			t.remove(), a.elem.off(a.trigger, e), a.elem.removeAttr("lay-key"), a.elem[0].eventHandler = !1, a.eventElem.off(a.trigger, e), a.eventElem.removeAttr("lay-key"), delete s.that[a.id]
		})
		...
		n(f)
			.on("mousedown", function(e) {
				var t, a;
				!p.thisId || (t = s.getThis(p.thisId)) && (a = t.config, e.target !== a.elem[0] && e.target !== a.eventElem[0] && e.target !== n(a.closeStop)[0] && t.remove())
			})
			.on("keydown", function(e) {
				var t;
				!p.thisId || (t = s.getThis(p.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === T.thisElemDate && (e.preventDefault(), n(t.footer)
					.find(E)[0].click())
			}), n(i)
			.on("resize", function() {
				if (p.thisId) {
					var e = s.getThis(p.thisId);
		...
		e = new T(e);
		return s.call(e)
	}, p.getInst = function(e) {
		e = s.getThis(e);
		if (e) return e.inst
	}, p.parse = function(a, n, i) {
	...
	}, p.getEndDate = function(e, t) {
		var a = new Date;
		return a.setFullYear(t || a.getFullYear(), e || a.getMonth() + 1, 1), new Date(a.getTime() - 864e5)
			.getDate()
	}, p.close = function(e) {
		e = s.getThis(e || p.thisId);
		if (e) return e.remove()
	}, p.destroy = function(e) {
		e = s.getThis(e || p.thisId);
		if (e) return e.destroy()
	}, n ? (p.ready(), layui.define("lay", function(e) {
		p.path = layui.cache.dir, l.run(lay), e(a, p)
	})) : "function" == typeof define && define.amd ? define(function() {
		return l.run(lay), p
	}) : (p.ready(), l.run(i.lay), i.laydate = p)
}(window, window.document);
! function(e, t) {
...
! function(p) {
	"use strict";
	var h, c, e, n = p.layui && layui.define,
		f = {
			...
			link: function(e, i, t) {
				...
				m.path && (n = document.getElementsByTagName("head")[0], a = document.createElement("link"), o = ((t = "string" == typeof i ? i : t) || e)
					.replace(/\.|\//g, ""), s = "layuicss-" + o, l = "creating", r = 0, a.rel = "stylesheet", a.href = m.path + e, a.id = s, document.getElementById(s) || n.appendChild(a), "function" == typeof i && function c(e) {
		...
		m = {
			...
			path: f.getPath,
			config: function(e, t) {
				return m.cache = f.config = h.extend({}, f.config, e = e || {}), m.path = f.config.path || m.path, "string" == typeof e.extend && (e.extend = [e.extend]), f.config.path && m.ready(), e.extend && (n ? layui.addcss("modules/layer/" + e.extend) : f.link("css/" + e.extend)), this
			},
			ready: function(e) {
				var t = "layer",
					i = (n ? "modules/" : "css/") + "layer.css?v=" + m.v;
		...
		t = function(e) {
			...
			t.index = ++m.index, t.config.maxWidth = h(c)
				.width() - 30, t.config = h.extend({}, t.config, f.config, e), document.body ? i() : setTimeout(function() {
					i()
				}, 30)
		},
		...
		i = (d.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], d.SHADE = "layui-layer-shade", d.MOVE = "layui-layer-move", t.pt.config = {
				...
				}() : "") + (a.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], s, h('<div class="' + d.MOVE + '" id="' + d.MOVE + '"></div>')), this
			}, t.pt.creat = function() {
				var e, n = this,
					a = n.config,
					o = n.index,
				...
				if (!a.id || !h("." + d[0])
					...
					switch ("string" == typeof a.area && (a.area = "auto" === a.area ? ["", ""] : [a.area, ""]), a.shift && (a.anim = a.shift), 6 == m.ie && (a.fixed = !1), a.type) {
						case 0:
							a.btn = "btn" in a ? a.btn : f.btn[0], m.closeAll("dialog");
							break;
						case 2:
					...
					n.vessel(s, function(e, t, i) {
							l.append(e[0]), s ? 2 == a.type || 4 == a.type ? h("body")
								.append(e[1]) : r.parents("." + d[0])[0] || (r.data("display", r.css("display"))
									.show()
									.addClass("layui-layer-wrap")
									.wrap(e[1]), h("#" + d[0] + o)
									.find("." + d[5])
									.before(t)) : l.append(e[1]), h("#" + d.MOVE)[0] || l.append(f.moveElem = i), n.layero = h("#" + d[0] + o), n.shadeo = h("#" + d.SHADE + o), a.scrollbar || d.html.css("overflow", "hidden")
								.attr("layer-full", o)
						})
						.auto(o), n.shadeo.css({
						...
						.attr("src", r[0]), 4 == a.type ? n.tips() : (n.offset(), parseInt(f.getStyle(document.getElementById(d.MOVE), "z-index")) || (n.layero.css("visibility", "hidden"), m.ready(function() {
				...
				e.tips[1] || o.remove(), a.autoLeft = function() {
						...
						a.tipLeft = a.left - i[0] - 10, a.tipTop = a.top, o.removeClass("layui-layer-TipsR")
							...
							.css("border-bottom-color", e.tips[1])
					}], a.where[n - 1](), 1 === n ? a.top - (c.scrollTop() + i[1] + 16) < 0 && a.where[2]() : 2 === n ? 0 < c.width() - (a.left + a.width + i[0] + 16) || a.where[3]() : 3 === n ? 0 < a.top - c.scrollTop() + a.height + i[1] + 16 - c.height() && a.where[0]() : 4 === n && 0 < i[0] + 16 - a.left && a.where[1](), t.find("." + d[5])
					.css({
				...
				return a.move && t.css("cursor", "move"), t.on("mousedown", function(e) {
					var t = h(this),
						i = {};
					a.move && (i.layero = o, i.config = a, i.offset = [e.clientX - parseFloat(o.css("left")), e.clientY - parseFloat(o.css("top"))], t.data(r[0], i), f.eventMoveElem = t, f.moveElem.css("cursor", "move")
						.show()), e.preventDefault()
				}), i.on("mousedown", function(e) {
					var t = h(this),
						i = {};
					a.resize && (i.layero = o, i.config = a, i.offset = [e.clientX, e.clientY], i.index = n.index, i.area = [o.outerWidth(), o.outerHeight()], t.data(r[1], i), f.eventResizeElem = t, f.moveElem.css("cursor", "se-resize")
						.show()), e.preventDefault()
				}), f.docEvent || (e.on("mousemove", function(e) {
						var t, i, n, a, o, s, l;
						f.eventMoveElem && (t = (a = f.eventMoveElem.data(r[0]) || {})
							.layero, o = a.config, s = e.clientX - a.offset[0], l = e.clientY - a.offset[1], i = "fixed" === t.css("position"), e.preventDefault(), a.stX = i ? 0 : c.scrollLeft(), a.stY = i ? 0 : c.scrollTop(), o.moveOut || (i = c.width() - t.outerWidth() + a.stX, n = c.height() - t.outerHeight() + a.stY, i < (s = s < a.stX ? a.stX : s) && (s = i), n < (l = l < a.stY ? a.stY : l) && (l = n)), t.css({
								left: s,
								top: l
							})), f.eventResizeElem && (o = (a = f.eventResizeElem.data(r[1]) || {})
							.config, s = e.clientX - a.offset[0], l = e.clientY - a.offset[1], e.preventDefault(), m.style(a.index, {
								width: a.area[0] + s,
								height: a.area[1] + l
					...
					.on("mouseup", function(e) {
						var t, i;
						f.eventMoveElem && (i = (t = f.eventMoveElem.data(r[0]) || {})
							.config, f.eventMoveElem.removeData(r[0]), delete f.eventMoveElem, f.moveElem.hide(), i.moveEnd && i.moveEnd(t.layero)), f.eventResizeElem && (f.eventResizeElem.removeData(r[1]), delete f.eventResizeElem, f.moveElem.hide())
					}), f.docEvent = !0), n
				...
				t.openLayer(), n.success && (2 == n.type ? i.find("iframe")
					...
					.on("click", function() {
						var e = h(this)
							.index();
						0 === e ? n.yes ? n.yes(t.index, i, t) : n.btn1 ? n.btn1(t.index, i, t) : m.close(t.index) : !1 !== (n["btn" + (e + 1)] && n["btn" + (e + 1)](t.index, i, t)) && m.close(t.index)
					}), i.find("." + d[7])
					.on("click", function() {
						!1 !== (n.cancel && n.cancel(t.index, i, t)) && m.close(t.index)
					}), n.shadeClose && t.shadeo.on("click", function() {
						m.close(t.index)
					}), i.find(".layui-layer-min")
					.on("click", function() {
						!1 !== (n.min && n.min(i, t.index, t)) && m.min(t.index, n)
					}), i.find(".layui-layer-max")
					.on("click", function() {
						h(this)
							.hasClass("layui-layer-maxmin") ? (m.restore(t.index), n.restore && n.restore(i, t.index, t)) : (m.full(t.index, n), setTimeout(function() {
			...
			.getChildFrame = function(e, t) {
				...
				var e = h("#" + d[0] + e),
					...
					.outerHeight() || 0;
				e.attr("minLeft");
				a !== f.type[3] && a !== f.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - o - s <= 64 && (t.height = 64 + o + s)), e.css(t), s = e.find("." + d[6])
				...
				var i = h("#" + d[0] + e),
					...
					a = i.find(d[1])
					.outerHeight() || 0,
					o = i.attr("minLeft") || 181 * f.minIndex + "px",
					s = i.css("position"),
					l = {
						width: 180,
						height: a,
				...
				f.record(i), f.minLeft[0] && (o = f.minLeft[0], f.minLeft.shift()), t.minStack && (l.left = o, l.top = c.height() - a, i.attr("minLeft") || f.minIndex++, i.attr("minLeft", o)), i.attr("position", s), m.style(e, l, !0), i.find(".layui-layer-min")
					.hide(), "page" === i.attr("type") && i.find(d[4])
					.hide(), f.rescollbar(e), n.hide()
				...
				m.style(e, {
					...
					.show(), f.rescollbar(e), i.show()
			}, m.full = function(t) {
				var i = h("#" + d[0] + t);
				f.record(i), d.html.attr("layer-full") || d.html.css("overflow", "hidden")
				...
				var e, s, t, l = (e = h("." + d[0])
						.find("#" + a)
						.closest("." + d[0]))[0] ? (a = e.attr("times"), e) : h("#" + d[0] + a),
					r = l.attr("type");
				l[0] && (s = "layui-layer-wrap", t = function() {
					...
					}, l.data("isOutAnim") && l.addClass("layer-anim layer-anim-close"), h("#layui-layer-moves, #" + d.SHADE + a)
					.remove(), 6 == m.ie && f.reselect(), f.rescollbar(a), l.attr("minLeft") && (f.minIndex--, f.minLeft.push(l.attr("minLeft"))), m.ie && m.ie < 10 || !l.data("isOutAnim") ? t() : setTimeout(function() {
						t()
					}, 200))
	...
	m.prompt = function(i, n) {
		...
		if ((n = n || {})
			...
			o.imgprev = function(e) {
				...
				if (!(s.length <= 1)) return i.start = o.imgIndex - 1, m.close(o.index), m.photos(n, !0, e)
			}, o.event = function() {
				o.bigimg.find(".layui-layer-imgprev")
					.on("click", function(e) {
						e.preventDefault(), o.imgprev(!0)
					}), o.bigimg.find(".layui-layer-imgnext")
					.on("click", function(e) {
			...
			var t = s[l].src,
				d = function(e) {
					m.close(o.loadi);
					var t, i = s[l].alt || "";
					a && (n.anim = -1), o.index = m.open(h.extend({
						type: 1,
						id: "layui-layer-photos",
						area: (e = [e.width, e.height], t = [h(p)
							.width() - 100, h(p)
							.height() - 100
						], !n.full && (e[0] > t[0] || e[1] > t[1]) && ((t = [e[0] / t[0], e[1] / t[1]])[1] < t[0] ? (e[0] = e[0] / t[0], e[1] = e[1] / t[0]) : t[0] < t[1] && (e[0] = e[0] / t[1], e[1] = e[1] / t[1])), [e[0] + "px", e[1] + "px"]),
						title: !1,
						shade: .9,
						shadeClose: !0,
						closeBtn: !1,
				...
				u = function() {
					m.close(o.loadi), m.msg("&#x5F53;&#x524D;&#x56FE;&#x7247;&#x5730;&#x5740;&#x5F02;&#x5E38;<br>&#x662F;&#x5426;&#x7EE7;&#x7EED;&#x67E5;&#x770B;&#x4E0B;&#x4E00;&#x5F20;&#xFF1F;", {
						time: 3e4,
						btn: ["&#x4E0B;&#x4E00;&#x5F20;", "&#x4E0D;&#x770B;&#x4E86;"],
						yes: function() {
		...
		c = (h = e)(p), d.html = h("html"), m.open = function(e) {
			return new t(e)
				.index
		}
	...
	var s = layui.$,
		...
		a = {
				...
				layui.each(i.bars, function(e, t) {
						...
						n.addClass(t.icon)
							...
							.html(t.content), n.on("click", function() {
								var e = s(this)
									.attr("lay-type");
								"top" === e && ("body" === i.target ? s("html,body") : c)
									.animate({
										scrollTop: 0
					...
					.remove(), "object" == typeof i.css && u.css(i.css), l.append(u), a && (t = function t() {
			...
			toDateString: function(e, t) {
				...
				return i.getDate() ? (t = t || "yyyy-MM-dd HH:mm:ss")
					.replace(/yyyy/g, a[0])
					.replace(/MM/g, a[1])
					.replace(/dd/g, a[2])
					.replace(/HH/g, n[0])
					.replace(/mm/g, n[1])
					.replace(/ss/g, n[2]) : (o.error('Invalid Msec for "util.toDateString(Msec)"'), "")
			},
			escape: function(e) {
				return e === undefined || null === e ? "" : /[<"'>]|&(?=#[a-zA-Z0-9]+)/g.test(e += "") ? e.replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;")
					.replace(/</g, "&lt;")
			...
			toVisibleArea: function(e) {
				...
				.scrollElem[0] && e.thisElem[0] && (t = e.scrollElem, l = e.thisElem, i = (o = "y" === e.type) ? "top" : "left", a = t[n = o ? "scrollTop" : "scrollLeft"](), o = t[o ? "height" : "width"](), r = t.offset()[i], c = {}, ((l = l.offset()[i] - r) > o - e.margin || l < e.margin) && (c[n] = l - o / 2 + a, t.animate(c, e.duration)))
			},
...
layui.define(["jquery", "laytpl", "lay"], function(e) {
	...
	V.prototype.config = {
				...
				d = function(r, e) {
					return layui.each(e, function(e, i) {
						...
						("-" === o || i.title || i.id || n) && ((l = s(["<li" + (t = {
							...
							}, n || o ? ' class="' + t[o] + '"' : "") + ">", (t = "href" in i ? '<a href="' + i.href + '" target="' + (i.target || "_self") + '">' + l + "</a>" : l, n ? '<div class="' + f + '">' + t + ("parent" === o ? '<i class="layui-icon layui-icon-right"></i>' : "group" === o && u.isAllowSpread ? '<i class="layui-icon layui-icon-' + (a ? "up" : "down") + '"></i>' : "") + "</div>" : '<div class="' + f + '">' + t + "</div>"), "</li>"].join("")))
			...
			!(e = "contextmenu" !== u.trigger && !lay.isTopElem(u.elem[0]) ? e : !0) && u.elem.data(c + "_opened") || (l.elemView = s(t), l.elemView.append(u.content || (e = s('<ul class="layui-menu layui-dropdown-menu"></ul>'), 0 < u.data.length ? d(e, u.data) : e.html('<li class="layui-menu-item-none">no menu</li>'), e)), u.className && l.elemView.addClass(u.className), u.style && l.elemView.attr("style", u.style), p.thisId = u.id, l.remove(), i.append(l.elemView), u.elem.data(c + "_opened", !0), l.position(), (y.prevElem = l.elemView)
				.data("prevElem", u.elem), l.elemView.find(".layui-menu")
				.on(o, function(e) {
					layui.stope(e)
				}), l.elemView.find(".layui-menu li")
				.on("click", function(e) {
					var i = s(this),
						t = i.data("item") || {},
						n = t.child && 0 < t.child.length,
						a = "all" === u.clickScope;
					n && !a || "-" === t.type || (n || l.remove(), "function" == typeof u.click && u.click(t, i), layui.stope(e))
				}), l.elemView.find(k)
				.on("click", function(e) {
					var i = s(this)
						.parent();
					"group" === (i.data("item") || {})
					.type && u.isAllowSpread && y.spread(i)
		...
		}, V.prototype.position = function(e) {
			var i = this.config;
			...
			e && (e.data("prevElem") && e.data("prevElem")
				.data(c + "_opened", !1), e.remove())
		}, V.prototype.delayRemove = function() {
			var e = this,
				i = e.config;
			...
			var i = e.children("." + f)
				.find(".layui-icon");
			e.hasClass(l) ? (e.removeClass(l)
				.addClass(u), i.removeClass("layui-icon-down")
				.addClass("layui-icon-up")) : (e.removeClass(u)
				.addClass(l), i.removeClass("layui-icon-up")
			...
			i.hasClass("layui-menu-item-divider") || n || (t.find("." + h)
				...
				.addClass(v), layui.event.call(this, r, "click(" + a + ")", l))
			...
			t[0] && ((i = t[0].getBoundingClientRect())
				...
				.css("margin-top", -(i.bottom - n.height() + 5)))
		})
...
layui.define("jquery", function(e) {
	...
	i.prototype.config = {
		...
		if (s[0] && s.remove(), n.elemTemp = g(i), l.range ? (n.elemTemp.find("." + x)
				.eq(0)
				.data("value", l.value[0]), n.elemTemp.find("." + x)
				.eq(1)
				.data("value", l.value[1])) : n.elemTemp.find("." + x)
		...
		l.input && !l.range && (e = g('<div class="layui-slider-input layui-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="layui-icon layui-icon-up"></i><i class="layui-icon layui-icon-down"></i></div></div>'), t.css("position", "relative"), t.append(e), t.find("." + M)
				.children("input")
				.val(l.value), "vertical" === l.type ? e.css({
					left: 0,
					top: -48
				}) : n.elemTemp.css("margin-right", e.outerWidth() + 15)), l.disabled ? (n.elemTemp.addClass(c), n.elemTemp.find("." + T)
				.addClass(c)) : n.slide(), n.elemTemp.find("." + T)
			.on("mouseover", function() {
				var e = "vertical" === l.type ? l.height : n.elemTemp[0].offsetWidth,
					i = n.elemTemp.find("." + x),
					t = ("vertical" === l.type ? e - g(this)
						.parent()[0].offsetTop - i.height() : g(this)
				...
				n.elemTemp.find("." + w)
					.html(e), clearTimeout(a), a = setTimeout(function() {
						"vertical" === l.type ? n.elemTemp.find("." + w)
							.css({
								bottom: t + "%",
								"margin-bottom": "20px",
								display: "inline-block"
			...
			.on("mouseout", function() {
				clearTimeout(a), n.elemTemp.find("." + w)
					.css("display", "none")
			})
		...
		var o = this,
			...
			c = u.find("." + x),
			v = u.next(".layui-slider-input"),
			m = v.children("." + M)
			.children("input")
			.val(),
			p = 100 / ((r.max - r.min) / Math.ceil(r.step)),
			f = function(e, i, t) {
				e = 100 < (e = 100 < Math.ceil(e) * p ? Math.ceil(e) * p : Math.round(e) * p) ? 100 : e, c.eq(i)
					.css("vertical" === r.type ? "bottom" : "left", e + "%");
				var a, n = h(c[0].offsetLeft),
					l = r.range ? h(c[1].offsetLeft) : 0,
					s = ("vertical" === r.type ? (u.find("." + w)
							.css({
								bottom: e + "%",
								"margin-bottom": "20px"
							}), n = h(d() - c[0].offsetTop - c.height()), l = r.range ? h(d() - c[1].offsetTop - c.height()) : 0) : u.find("." + w)
						.css("left", e + "%"), n = 100 < n ? 100 : n, l = 100 < l ? 100 : l, Math.min(n, l)),
					n = Math.abs(n - l),
					l = ("vertical" === r.type ? u.find("." + b)
						.css({
							height: n + "%",
							bottom: s + "%"
						}) : u.find("." + b)
				...
				m = l, v.children("." + M)
					.children("input")
					.val(m), c.eq(i)
					.data("value", l), u.find("." + w)
					.html(r.setTips ? r.setTips(l) : l), r.range && (a = [c.eq(0)
						.data("value"), c.eq(1)
						.data("value")
			...
			.each(function(l) {
				...
				s.on("mousedown", function(e) {
					...
					e = function(e) {
							...
							f(i, l), s.addClass(L), u.find("." + w)
								.show(), e.preventDefault()
						}, i = function() {
							s.removeClass(L), u.find("." + w)
								.hide()
						}, t = function() {
							i && i(), y.remove(), r.done && r.done(o.value)
						}, g("#LAY-slider-moving")[0] || g("body")
						.append(y), y.on("mousemove", e), y.on("mouseup", t)
						.on("mouseleave", t)
				})
			}), u.on("click", function(e) {
				var i = g("." + T),
					t = g(this);
				!i.is(event.target) && 0 === i.has(event.target)
					.length && i.length && (t = (i = (i = (i = "vertical" === r.type ? d() - e.clientY + t.offset()
						.top - g(window)
						.scrollTop() : e.clientX - t.offset()
						.left - g(window)
						.scrollLeft()) < 0 ? 0 : i) > d() ? d() : i) / d() * 100 / p, i = r.range ? "vertical" === r.type ? Math.abs(i - parseInt(g(c[0])
						.css("bottom"))) > Math.abs(i - parseInt(g(c[1])
						.css("bottom"))) ? 1 : 0 : Math.abs(i - c[0].offsetLeft) > Math.abs(i - c[1].offsetLeft) ? 1 : 0 : 0, f(t, i, "done"), e.preventDefault())
			}), v.children(".layui-slider-input-btn")
			.children("i")
			.each(function(i) {
				g(this)
					.on("click", function() {
						m = v.children("." + M)
							.children("input")
							.val();
						var e = ((m = 1 == i ? m - r.step < r.min ? r.min : Number(m) - r.step : Number(m) + r.step > r.max ? r.max : Number(m) + r.step) - r.min) / (r.max - r.min) * 100 / p;
						f(e, 0, "done")
					})
			});
		var a = function() {
...
layui.define(["jquery", "lay"], function(e) {
	...
	var k = layui.$,
		...
		I = "layui-colorpicker-alpha-bgcolor",
	...
	d.prototype.config = {
		...
		k.extend(i, t.options(o[0]));
		var o = k(['<div class="layui-unselect layui-colorpicker">', "<span " + ("rgb" == i.format && i.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : "") + ">", '<span class="layui-colorpicker-trigger-span" ', 'lay-type="' + ("rgb" == i.format ? i.alpha ? "rgba" : "torgb" : "") + '" ', 'style="' + (o = "", i.color ? (o = i.color, 3 < (i.color.match(/[0-9]{1,3}/g) || [])
				.length && (i.alpha && "rgb" == i.format || (o = "#" + f(M(Y(i.color))))), "background: " + o) : o) + '">', '<i class="layui-icon layui-colorpicker-trigger-i ' + (i.color ? m : x) + '"></i>', "</span>", "</span>", "</div>"].join("")),
			r = i.elem = k(i.elem);
		i.size && o.addClass("layui-colorpicker-" + i.size), r.addClass("layui-inline")
			.html(e.elemColorBox = o), i.id = "id" in i ? i.id : e.index, e.color = e.elemColorBox.find("." + P)[0].style.background, e.events()
		...
		k(a)[0] && k(a)
			.data("index") == e.index ? e.removePicker(d.thisElemInd) : (e.removePicker(d.thisElemInd), k("body")
				.append(t)), n.thisId = i.id, d.thisElemInd = e.index, d.thisColor = r.style.background, e.position(), e.pickerEvents()
		...
		t ? (e = M(Y(t)), o = o.attr("lay-type"), i.select(e.h, e.s, e.b), "torgb" === o && r.find("input")
			.val(t), "rgba" === o && (e = Y(t), 3 == (t.match(/[0-9]{1,3}/g) || [])
				.length ? (r.find("input")
					.val("rgba(" + e.r + ", " + e.g + ", " + e.b + ", 1)"), i.elemPicker.find("." + D)
					.css("left", 280)) : (r.find("input")
					.val(t), o = 280 * t.slice(t.lastIndexOf(",") + 1, t.length - 1), i.elemPicker.find("." + D)
					.css("left", o)), i.elemPicker.find("." + I)[0].style.background = "linear-gradient(to right, rgba(" + e.r + ", " + e.g + ", " + e.b + ", 0), rgb(" + e.r + ", " + e.g + ", " + e.b + "))")) : (i.select(0, 100, 100), r.find("input")
			.val(""), i.elemPicker.find("." + I)[0].style.background = "", i.elemPicker.find("." + D)
			.css("left", 280))
	}, d.prototype.side = function() {
		var t = this,
			n = t.config,
			l = t.elemColorBox.find("." + P),
			c = l.attr("lay-type"),
			a = t.elemPicker.find(".layui-colorpicker-side"),
			e = t.elemPicker.find("." + B),
			s = t.elemPicker.find("." + w),
			r = t.elemPicker.find("." + E),
			d = t.elemPicker.find("." + I),
			f = t.elemPicker.find("." + D),
			u = e[0].offsetTop / 180 * 360,
			g = 100 - (r[0].offsetTop + 3) / 180 * 100,
			p = (r[0].offsetLeft + 3) / 260 * 100,
			h = Math.round(f[0].offsetLeft / 280 * 100) / 100,
			v = t.elemColorBox.find("." + C),
			i = t.elemPicker.find(".layui-colorpicker-pre")
			.children("div"),
			y = function(e, i, o, r) {
				t.select(e, i, o);
				e = T({
				...
				v.addClass(m)
					.removeClass(x), l[0].style.background = "rgb(" + e.r + ", " + e.g + ", " + e.b + ")", "torgb" === c && t.elemPicker.find("." + F)
					.find("input")
					.val("rgb(" + e.r + ", " + e.g + ", " + e.b + ")"), "rgba" === c && (f.css("left", 280 * r), t.elemPicker.find("." + F)
						.find("input")
						.val("rgba(" + e.r + ", " + e.g + ", " + e.b + ", " + r + ")"), l[0].style.background = "rgba(" + e.r + ", " + e.g + ", " + e.b + ", " + r + ")", d[0].style.background = "linear-gradient(to right, rgba(" + e.r + ", " + e.g + ", " + e.b + ", 0), rgb(" + e.r + ", " + e.g + ", " + e.b + "))"), n.change && n.change(t.elemPicker.find("." + F)
						.find("input")
						.val())
			},
			o = k(['<div class="layui-auxiliar-moving" id="LAY-colorpicker-moving"></div>'].join("")),
			b = function(e) {
				k("#LAY-colorpicker-moving")[0] || k("body")
		...
		e.on("mousedown", function(e) {
			...
			b(function(e) {
				...
				y(u = o, p, g, h), e.preventDefault()
			}), e.preventDefault()
		}), a.on("click", function(e) {
			var i = e.clientY - k(this)
				.offset()
				.top,
				i = (i = (i = i < 0 ? 0 : i) > this.offsetHeight ? this.offsetHeight : i) / 180 * 360;
			y(u = i, p, g, h), e.preventDefault()
			...
			layui.stope(e), b(function(e) {
				...
				y(u, p = t, g = o, h), e.preventDefault()
			}), e.preventDefault()
		}), s.on("mousedown", function(e) {
			var i = e.clientY - k(this)
				.offset()
				...
				i = 100 - (i + 3) / 180 * 100;
			y(u, p = o, g = i, h), layui.stope(e), e.preventDefault(), r.trigger(e, "mousedown")
			...
			b(function(e) {
				...
				y(u, p, g, h = o), e.preventDefault()
			}), e.preventDefault()
		}), d.on("click", function(e) {
			var i = e.clientX - k(this)
				.offset()
				.left,
				i = ((i = i < 0 ? 0 : i) > this.offsetWidth && (i = this.offsetWidth), Math.round(i / 280 * 100) / 100);
			y(u, p, g, h = i), e.preventDefault()
		}), i.each(function() {
			k(this)
				.on("click", function() {
					k(this)
					...
					u = i.h, p = i.s, g = i.b, 3 == (e.match(/[0-9]{1,3}/g) || [])
						.length && (o = 1), h = o, y(i.h, i.s, i.b, o)
				})
		})
		...
		var t = this,
			...
			i = i / 100 * 260 - 3;
		t.elemPicker.find("." + B)
			.css("top", e), t.elemPicker.find("." + w)[0].style.background = "#" + n, t.elemPicker.find("." + E)
			.css({
				top: o,
				left: i
			}), "change" !== r && t.elemPicker.find("." + F)
			.find("input")
			.val("#" + l)
			...
			o = {
				...
				confirm: function(e, i) {
					var o, r, t = d.val(),
						n = t,
						l = {};
					if (-1 < t.indexOf(",") ? (l = M(Y(t)), c.select(l.h, l.s, l.b), s[0].style.background = n = "#" + f(l), 3 < (t.match(/[0-9]{1,3}/g) || [])
						.length && "rgba" === s.attr("lay-type") && (o = 280 * t.slice(t.lastIndexOf(",") + 1, t.length - 1), c.elemPicker.find("." + D)
							.css("left", o), n = s[0].style.background = t)) : (3 == (o = -1 < (o = t)
							.indexOf("#") ? o.substring(1) : o)
						.length && (o = (r = o.split(""))[0] + r[0] + r[1] + r[1] + r[2] + r[2]), r = {
							r: (o = parseInt(o, 16)) >> 16,
							g: (65280 & o) >> 8,
							b: 255 & o
						}, l = M(r), s[0].style.background = n = "#" + f(l), c.elemColorBox.find("." + C)
						.removeClass(x)
						.addClass(m)), "change" === i) return c.select(l.h, l.s, l.b, i), void(a.change && a.change(n));
		...
		var i, o, r;
		!n.thisId || (i = l.getThis(n.thisId)) && (o = i.config, r = i.elemColorBox.find("." + P), k(e.target)
			.hasClass(c) || k(e.target)
			.parents("." + c)[0] || k(e.target)
			.hasClass(a.replace(/\./g, "")) || k(e.target)
			.parents(a)[0] || i.elemPicker && (i.color ? (e = M(Y(i.color)), i.select(e.h, e.s, e.b)) : i.elemColorBox.find("." + C)
				.removeClass(m)
				.addClass(x), r[0].style.background = i.color || "", "function" == typeof o.cancel && o.cancel(i.color), i.removePicker()))
		...
		C = {
			...
			tabDelete: function(t, i) {
				var i = i || u(this)
					...
					.children(".layui-tab-item"),
					n = e.attr("lay-filter");
				i.hasClass(r) && (i.next()[0] && i.next()
						.is("li") ? C.tabClick.call(i.next()[0], null, a + 1) : i.prev()[0] && i.prev()
						.is("li") && C.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), l.eq(a)
	...
	var C = layui.$,
		...
		i = (t.prototype.set = function(e) {
			...
			var i = this.config,
				...
				n = {
					input: function(e) {
						...
						i.autocomplete && e.attr("autocomplete", i.autocomplete), a.find("input[lay-affix],textarea[lay-affix]")
							.each(function() {
								var i = C(this),
									t = i.attr("lay-affix"),
									a = i.next(".layui-input-suffix"),
									n = function(e, t) {
										e && e[C.trim(t) ? "removeClass" : "addClass"]($)
									},
									l = function(e) {
										a.remove(), a = C(['<div class="layui-input-suffix layui-input-affix-event">', '<i class="layui-icon layui-icon-' + e + '"></i>', "</div>"].join("")), i.after(a), n(a, i.val()), i.on("input propertychange", function() {
											var e = this.value;
											n(a, e)
										}), a.on("click", function() {
											var e = i.attr("lay-filter");
											r[t] && r[t][1].call(this), layui.event.call(this, w, "input-affix(" + e + ")", {
												elem: i[0],
												affix: t
											})
										})
									...
									r = {
										...
										eye: [function() {
											...
											var e = "LAY_FORM_INPUT_AFFIX_SHOW",
												t = i.data(e);
											i.attr("type", t ? "password" : "text")
												.data(e, !t), l(t ? "eye" : "eye-invisible")
										}]
									};
								r[t] && r[t][0]()
							})
						...
						var p, c = "\u8bf7\u9009\u62e9",
							...
							b = function(e, t) {
								C(e.target)
									.parent()
									.hasClass(g) && !t || (C("." + m)
										.removeClass(m + "ed " + m + "up"), p && k && p.val(k)), p = null
							},
							u = function(a, e, t) {
								...
								e || (r = c.attr("lay-search"), i = function() {
										var e = a.offset()
											.top + a.outerHeight() + 5 - E.scrollTop(),
											t = f.outerHeight();
										v = c[0].selectedIndex, a.addClass(m + "ed"), h.removeClass($), y.removeClass($), s = null, h.eq(v)
											.addClass(T)
											.siblings()
											.removeClass(T), e + t > E.height() && t <= e && a.addClass(m + "up"), o()
									}, n = function(e) {
										a.removeClass(m + "ed " + m + "up"), d.blur(), s = null, e || l(d.val(), function(e) {
											var t = c[0].selectedIndex;
											e && (k = C(c[0].options[t])
												.html(), 0 === t && k === d.attr("placeholder") && (k = ""), d.val(k || ""))
										})
									}, o = function() {
										...
										a.hasClass(m + "ed") ? n() : (b(e, !0), i()), f.find("." + x)
											.remove()
									}), u.find(".layui-edge")
									.on("click", function() {
										d.focus()
									...
									.on("keydown", function(l) {
										var e = l.keyCode,
											r = (9 === e && n(), function(a, n) {
												...
												var e = function() {
													...
													t = e[a](),
													i = e[a]("dd:not(." + $ + ")");
												return t[0] ? (s = e[a](), i[0] && !i.hasClass(F) || !s[0] ? (i.addClass(T)
													.siblings()
													.removeClass(T), void o()) : r(a, s)) : s = null
											});
										...
										l(t, function(e) {
												e ? f.find("." + x)[0] || f.append('<p class="' + x + '">\u65e0\u5339\u914d\u9879</p>') : f.find("." + x)
													.remove()
											}, "keyup"), "" === t && f.find("." + x)
											.remove(), o()
									})
									.on("blur", function(e) {
										var t = c[0].selectedIndex;
										p = d, k = C(c[0].options[t])
											.html(), 0 === t && k === d.attr("placeholder") && (k = ""), setTimeout(function() {
												l(d.val(), function(e) {
													k || d.val("")
												}, "blur")
											}, 200)
										...
										var e = C(this),
											t = e.attr("lay-value"),
											i = c.attr("lay-filter");
										return e.hasClass(F) || (e.hasClass("layui-select-tips") ? d.val("") : (d.val(e.text()), e.addClass(T)), e.siblings()
					...
					radio: function(e) {
						...
						e.each(function(e, t) {
							...
							if ("string" == typeof i.attr("lay-ignore")) return i.show();
							a[0] && a.remove();
							n = C(['<div class="layui-unselect ' + r, t.checked ? " " + r + "ed" : "", (n ? " layui-radio-disabled " + F : "") + '">', '<i class="layui-anim layui-icon">' + s[t.checked ? 0 : 1] + "</i>", "<div>" + (a = d.escape(t.title || ""), a = "string" == typeof i.next()
								...
								function(a) {
									...
									a.on("click", function() {
										...
										n[0].disabled || (layui.each(e, function() {
											...
											.addClass(l)
											.html(s[0]), layui.event.call(n[0], w, "radio(" + i + ")", {
												elem: n[0],
												value: n[0].value,
												othis: a
											}))
			...
			var i = C(this),
				...
				a = this.getFormElem ? this.getFormElem(e) : i.parents(o)
				.eq(0),
				n = a.find("*[lay-verify]");
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(e) {
	...
	var v = layui.$,
		...
		C = function(e) {
			var t = this.config || {},
				...
				i = e.content,
				t = (("escape" in a ? a : t)
					.escape && (i = x.escape(i)), e.text && a.exportTemplet || a.templet || a.toolbar);
			return t && (i = "function" == typeof t ? t.call(a, e.tplData, e.obj) : g(v(t)
						.html() || String(i))
					.render(v.extend({
						LAY_COL: a
					}, e.tplData))), e.text ? v("<div>" + i + "</div>")
				.text() : i
		},
		w = "table",
		t = ".layui-table",
		...
		c = "layui-none",
		L = "layui-table-view",
		s = ".layui-table-header",
		N = ".layui-table-body",
		D = ".layui-table-pageview",
		W = ".layui-table-sort",
		A = "layui-table-edit",
		E = "layui-table-hover",
		_ = "laytable-cell-group",
		j = "layui-table-col-special",
		M = "LAY_TABLE_MOVE_DICT",
		a = function(e) {
		...
		y = (n.prototype.config = {
			...
			a.height && /^full-\d+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1], a.height = R.height() - t.fullHeightGap) : a.height && /^#\w+-{1}\d+$/.test(a.height) && (e = a.height.split("-"), t.parentHeightGap = e.pop(), t.parentDiv = e.join("-"), a.height = v(t.parentDiv)
				.height() - t.parentHeightGap), a.index = t.index, t.key = a.id || a.index, t.setInit();
			var i, l, e = a.elem,
				n = e.next("." + L),
				o = t.elem = v("<div></div>");
			o.addClass((i = [L, L + "-" + t.index, "layui-form", "layui-border-box"], a.className && i.push(a.className), i.join(" ")))
				.attr({
			...
			r.css && -1 === r.css.indexOf(L) && (a = r.css.split("}"), layui.each(a, function(e, t) {
				t && (a[e] = "." + L + "-" + d.index + " " + t)
			}), r.css = a.join("}"));
			...
			i[0] && (t = t.split("-"), t = a.cols[t[1]][t[2]], e ? l-- : l++, i.attr("colspan", l), i[l < 1 ? "addClass" : "removeClass"](T), t.colspan = l, t.hide = l < 1, (a = i.data("parentkey")) && this.setParentCol(e, a))
			...
			var e, l = this;
			l.config.cols.length <= 1 || (e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + _)
				.get()
				.reverse(), layui.each(e, function() {
					var e = v(this),
						t = e.parent()
						.data("key"),
						a = 0;
					l.layHeader.eq(0)
						...
						.width(function(e, t) {
							v(this)
								.hasClass(T) || 0 < t && (a += t)
						}), a && e.css("max-width", a), i && e.parent()
			...
			0 < n.autoColNums && -i <= l && l <= i && (e = (a = (t = function(e) {
					...
					})), n.setGroupWidth(), n.layMain.find("tbody")
				.is(":empty") && (e = n.layHeader.first()
					.children("table")
					.width(), n.layMain.find("table")
					.width(e)), n.loading(!0)
			...
			a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(T), t.layMain.find("tbody")
				.html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(r), t.layPage.find(D)
				.addClass(r), k.cache[t.key] = [], t.syncCheckAll()
			...
			a = a || {}, "function" == typeof l.before && l.before(l), i.startTime = (new Date)
				.getTime(), l.url ? ((e = {})[n.pageName] = t, e[n.limitName] = l.limit, n = v.extend(e, l.where), l.contentType && 0 == l.contentType.indexOf("application/json") && (n = JSON.stringify(n)), i.loading(), v.ajax({
					type: l.method || "get",
					url: l.url,
					...
					success: function(e) {
						(e = "function" == typeof l.parseData ? l.parseData(e) || e : e)[o.statusName] != o.statusCode ? (i.renderForm(), i.errorView(e[o.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + o.statusName + '": ' + o.statusCode)) : (i.renderData({
							...
							.getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof l.done && l.done(e, t, e[o.countName])
					},
					error: function(e, t) {
						i.errorView("\u8bf7\u6c42\u5f02\u5e38\uff0c\u9519\u8bef\u63d0\u793a\uff1a" + t), i.renderForm(), i.setColsWidth(), "function" == typeof l.error && l.error(e, t)
					}
				})) : "array" === layui.type(l.data) && (e = t * l.limit - l.limit, (n = {})[o.dataName] = l.data.concat()
					.splice(e, l.limit), n[o.countName] = l.data.length, "object" == typeof l.totalRow && (n[o.totalRowName] = v.extend({}, l.totalRow)), i.renderData({
						res: n,
						curr: t,
						count: n[o.countName],
						type: a.type
					...
					layui.each(h, function(o, d) {
							...
							"array" === layui.type(d) && 0 === d.length || (d[k.config.numbersName] = c, n || (d[k.config.indexName] = o), u.eachCols(function(e, l) {
								var e = l.field || e,
									t = l.key,
									n = d[e];
								n !== undefined && null !== n || (n = ""), l.colGroup || (t = ['<td data-field="' + e + '" data-key="' + t + '" ' + (e = [], l.edit && e.push('data-edit="true"'), l.templet && e.push('data-content="' + x.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), e.join(" ")) + ' class="' + (e = [], l.hide && e.push(T), l.field || e.push(j), e.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? t : t + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + (e = [], l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ">" + function() {
									var e, t = v.extend(!0, {
											LAY_COL: l
										}, d),
									...
									return l.toolbar ? g(v(l.toolbar)
											.html() || "")
										.render(t) : C.call(u, {
											item3: l,
											content: n,
							...
							}), p.push('<tr data-index="' + o + '">' + a.join("") + "</tr>"), f.push('<tr data-index="' + o + '">' + i.join("") + "</tr>"), m.push('<tr data-index="' + o + '">' + r.join("") + "</tr>"))
						}), "fixed" === y.scrollPos && "reloadData" === e.type || u.layBody.scrollTop(0), "reset" === y.scrollPos && u.layBody.scrollLeft(0), u.layMain.find("." + c)
						.remove(), u.layMain.find("tbody")
						.html(p.join("")), u.layFixLeft.find("tbody")
						.html(f.join("")), u.layFixRight.find("tbody")
						.html(m.join("")), u.renderForm(), "number" == typeof s && u.setThisRowChecked(s), u.syncCheckAll(), u.fullSize(), u.haveInit ? u.scrollPatch() : setTimeout(function() {
							u.scrollPatch()
						}, 50), u.haveInit = !0, b.close(u.tipsIndex)
				};
			return k.cache[u.key] = h, u.layTotal[0 == h.length ? "addClass" : "removeClass"](r), u.layPage[y.page || y.pagebar ? "removeClass" : "addClass"](T), u.layPage.find(D)[!y.page || 0 == a || 0 === h.length && 1 == l ? "addClass" : "removeClass"](r), 0 === h.length ? (u.renderForm(), u.errorView(y.text.none)) : (u.layFixLeft.removeClass(T), n ? i() : (i(), u.renderTotal(h, t), u.layTotal && u.layTotal.removeClass(T), void(y.page && (y.page = v.extend({
			...
			}, y.page), y.page.count = a, o.render(y.page)))))
			...
			n.sortKey = {
				...
				field: s,
				type: e
			}, layui.event.call(l, w, "sort(" + r + ")", v.extend({
				config: d
			}, d.initSort)))
			...
			t.config.loading && (e ? (t.layInit && t.layInit.remove(), delete t.layInit, t.layBox.find(".layui-table-init")
				.remove()) : (t.layInit = v(['<div class="layui-table-init">', '<i class="layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop"></i>', "</div>"].join("")), t.layBox.append(t.layInit)))
			...
			var e = this,
				t = e.config,
				a = t.height;
			e.fullHeightGap ? (a = R.height() - e.fullHeightGap, e.elem.css("height", a = a < 135 ? 135 : a)) : e.parentDiv && e.parentHeightGap && (a = v(e.parentDiv)
				.height() - e.parentHeightGap, e.elem.css("height", a = a < 135 ? 135 : a)), a && (a = parseFloat(a) - (e.layHeader.outerHeight() || 38), t.toolbar && (a -= e.layTool.outerHeight() || 50), t.totalRow && (a -= e.layTotal.outerHeight() || 40), (t.page || t.pagebar) && (a -= e.layPage.outerHeight() || 43), e.layMain.outerHeight(a))
			...
			var e = this,
				...
				n = function(e) {
					var t;
					a && i ? (e = e.eq(0))
						.find(".layui-table-patch")[0] || ((t = v('<th class="layui-table-patch"><div class="layui-table-cell"></div></th>'))
							.find("div")
							.css({
								width: a
							}), e.find("tr")
			...
			e.layFixed.find(N)
				.css("height", t.height() >= n ? n : "auto"), e.layFixRight[0 < l ? "removeClass" : "addClass"](T), e.layFixRight.css("right", a - 1)
			...
			var s = this,
				...
				d = (s.layTool.on("click", "*[lay-event]", function(e) {
						var a, i = v(this),
							...
							l = function(e) {
								var t = v(e.list),
									a = v('<ul class="layui-table-tool-panel"></ul>');
								a.html(t), u.height && a.css("max-height", u.height - (s.layTool.outerHeight() || 50)), i.find(".layui-table-tool-panel")[0] || i.append(a), s.renderForm(), a.on("click", function(e) {
									layui.stope(e)
								}), e.done && e.done(a, t)
							};
						switch (layui.stope(e), S.trigger("table.tool.panel.remove"), b.close(s.tipsIndex), t) {
							case "LAYTABLE_COLS":
								l({
									list: (a = [], s.eachCols(function(e, t) {
										t.field && "normal" == t.type && a.push('<li><input type="checkbox" name="' + t.field + '" data-key="' + t.key + '" data-parentkey="' + (t.parentKey || "") + '" lay-skin="primary" ' + (t.hide ? "" : "checked") + ' title="' + x.escape(v("<div>" + (t.title || t.field) + "</div>")
							...
							case "LAYTABLE_PRINT":
								...
								d.append(s.layMain.find("table")
										.html()), d.append(s.layTotal.find("table")
										.html()), d.find("th.layui-table-patch")
									.remove(), d.find("thead>tr>th." + j)
									.filter(function(e, t) {
										return !v(t)
											.children("." + _)
											.length
									})
									.remove(), d.find("tbody>tr>td." + j)
					...
					.on("mousedown", function(e) {
						...
						}), a.data(M, o), m.eventMoveElem = a)
					}), m.docEvent || S.on("mousemove", function(e) {
						var t, a;
						m.eventMoveElem && (t = m.eventMoveElem.data(M) || {}, m.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule && (e = t.ruleWidth + e.clientX - t.offset[0], a = m.eventMoveElem.closest("." + L)
							.attr("lay-id"), (a = m.that[a]) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(m.eventMoveElem), b.close(s.tipsIndex))))
					})
					.on("mouseup", function(e) {
						var t, a, i, l;
						m.eventMoveElem && (i = (t = m.eventMoveElem)
							.closest("." + L)
							.attr("lay-id"), (a = m.that[i]) && (i = t.data("key"), l = a.col(i), o = {}, n.css("cursor", ""), a.scrollPatch(), t.removeData(M), delete m.eventMoveElem, a.getCssRule(i, function(e) {
							...
							update: function(e, d) {
								e = e || {}, layui.each(e, function(i, l) {
									...
									i in c && (c[i] = l), s.eachCols(function(e, t) {
										...
										})), n.data("content", l)) : d && (t.templet || t.toolbar) && (e = r.children('td[data-field="' + (t.field || e) + '"]'), a = c[t.field], e.children(y)
											.html(C.call(s, {
												item3: t,
												content: a,
												tplData: v.extend({
				...
				t = (s.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
						...
						}), s.setThisRowChecked(i), layui.event.call(this, w, "radio(" + r + ")", d.call(this, {
							checked: t
						}))
					}), s.layBody.on("mouseenter", "tr", function() {
						var e = v(this),
							t = e.index();
						e.data("off") || s.layBody.find("tr:eq(" + t + ")")
							.addClass(E)
					})
				...
				c = function(e, t) {
					var a, i, l, n;
					(e = v(e))
					.data("off") || (a = e.data("field"), n = e.data("key"), n = s.col(n), i = e.closest("tr")
						.data("index"), i = k.cache[s.key][i], l = e.children(y), (n = "function" == typeof n.edit ? n.edit(i) : n.edit) && ((n = v("textarea" === n ? '<textarea class="layui-input ' + A + '"></textarea>' : '<input class="layui-input ' + A + '">'))[0].value = e.data("content") || i[a] || l.text(), e.find("." + A)[0] || e.append(n), n.focus(), t && layui.stope(t)))
				},
				...
				a = function(e) {
					...
					t.data("off") || (e ? t.find(".layui-table-grid-down")
						.remove() : !(a.prop("scrollWidth") > a.outerWidth() || 0 < a.find("br")
							.length) || u.lineStyle || a.find("." + i)[0] || t.append('<div class="' + i + '"><i class="layui-icon layui-icon-down"></i></div>'))
				},
			...
			s.layBody.on("click", "*[lay-event]", function(e) {
				...
				.on("dblclick", "*[lay-event]", function(e) {
					...
					var e = v(this),
						t = e.scrollLeft(),
						e = e.scrollTop();
					s.layHeader.scrollLeft(t), s.layTotal.scrollLeft(t), s.layFixed.find(N)
						.scrollTop(e), b.close(s.tipsIndex)
			...
			v(".layui-table-tool-panel")
				.remove()
		}), k.init = function(a, i) {
			i = i || {};
			var e = v(a ? 'table[lay-filter="' + a + '"]' : t + "[lay-data]," + t + "[lay-options]"),
							...
							.each(function(e) {
								var t = v(this),
									...
									a = d.options(this, {
										...
										errorText: l + (a || t.attr("lay-options"))
									}),
									t = v.extend({
										title: t.text(),
	...
	k.eachCols = function(e, a, i) {
		...
		if (f.ie) return p.error("IE_NOT_SUPPORT_EXPORTS");
		u.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((d = [], i = [], l = [], r = {}, layui.each(t, function(l, n) {
			...
			"object" == typeof e ? (layui.each(e, function(e, t) {
				...
				var a, i;
				t.field && "normal" == t.type && (t.hide ? 0 == l && (r[t.field] = !0) : (a = n[t.field], i = c.layBody.find('tr[data-index="' + l + '"]>td'), a !== undefined && null !== a || (a = ""), 0 == l && d.push(t.title || ""), o.push('"' + C.call(c, {
					item3: t,
					content: a,
					tplData: n,
					text: "text",
		...
		e ? l(e) && m.that[e].resize() : layui.each(m.that, function() {
			this.resize()
		})
	}, k.reload = function(e, t, a, i) {
		if (l(e)) return e = m.that[e], e.reload(t, a, i), m.call(e)
...
layui.define(["laytpl", "form"], function(e) {
	...
	v.prototype.config = {
		...
		r = r || {}, c.layBox.each(function(e) {
			...
			}), t.prop("checked", l && n === i.length), c.layBtn.eq(e)[l ? "removeClass" : "addClass"](h), r.stopNone || (i = a.children("li:not(." + d + ")")
			...
			.on("keyup", function() {
				var i = this.value,
					...
					t = (t.each(function() {
						...
						}), n.renderCheckBtn(), t.length === e.children("li." + d)
						.length);
...
layui.define("jquery", function(e) {
	...
	i.prototype.config = {
		...
		i.elem = a(i.elem), i.elem[0] && (e.elemItem = i.elem.find(">*[carousel-item]>*"), i.index < 0 && (i.index = 0), i.index >= e.elemItem.length && (i.index = e.elemItem.length - 1), i.interval < 800 && (i.interval = 800), i.full ? i.elem.css({
			...
			.addClass(d), e.elemItem.length <= 1 || (e.indicator(), e.arrow(), e.autoplay(), e.events()))
		...
		n.elem.attr("lay-indicator", n.indicator), n.elem.find("." + o)[0] && n.elem.find("." + o)
		...
		n.haveSlide || ("sub" === e ? (n.subIndex(i), t.eq(a.index)
				...
				t.removeClass(d + " " + c + " " + m + " " + s + " " + u), t.eq(a.index)
					.addClass(d), n.haveSlide = !1
			}, 300), n.elemInd.find("li")
			.eq(a.index)
			.addClass(d)
			.siblings()
			.removeClass(d), n.haveSlide = !0, e = {
				index: a.index,
				prevIndex: o,
				item: t.eq(a.index)
...
layui.define(["lay", "util"], function(e) {
	...
	e("code", function(e) {
		...
		e.elem = d(e.elem), e.elem[0] && layui.each(e.elem.get()
			.reverse(),
			function(e, l) {
				var a, t = d(l),
					i = (i = t.html(), d.trim(i)
					...
					n = d('<div class="' + u + '">');
				t.addClass("layui-code-view layui-box"), l.skin && ("notepad" === l.skin && (l.skin = "dark"), t.addClass("layui-code-" + l.skin)), i = (i = l.encode ? o.escape(i) : i)
					.replace(/[\r\t\n]+/g, "</li><li>"), t.html(s.html("<li>" + i + "</li>")), t.children("." + u)[0] || (n.html(l.title + (l.about ? '<div class="layui-code-about">' + l.about + "</div>" : "")), t.prepend(n)), 0 < (i = Math.floor(s.find("li")
						.length / 100)) && s.css("margin-left", i + "px"), l.height && s.css("max-height", l.height)
			})
	})
